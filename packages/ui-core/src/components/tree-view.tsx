...
const treeVariants = cva(
  "group relative hover:before:opacity-100 before:absolute before:left-0 before:h-[2rem] before:w-full before:rounded-lg before:bg-accent/70 before:opacity-0 before:-z-10 px-2"
);
...
const TreeView = React.forwardRef<HTMLDivElement, TreeProps>(
  (
    ...
    const expandedItemIds = React.useMemo(() => {
      const targetId = controlledSelectedItemId ?? initialSelectedItemId;
      ...
      return ids;
    }, [controlledSelectedItemId, data, expandAll, initialSelectedItemId]);
